                      ...
                      >
                        ...
                        <div className="mb-3">
                          <p className="text-sm font-medium text-stone-800">
                            {currentLang === "en" ? "Photo note & location" : "Fotoğraf notu ve konumu"}
                          </p>
                          <p className="mt-1 text-xs leading-5 text-stone-500">
                            {currentLang === "en"
                              ? "Optional. These details will be used in Map Mode."
                              : "Zorunlu değil. Harita Modu için kullanılır."}
                          </p>
                        </div>
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          <input
                            ...
                            placeholder={currentLang === "en" ? "Location name" : "Konum adı"}
                            className="rounded-2xl border border-stone-200 px-4 py-3 text-sm outline-none focus:border-stone-500 md:col-span-2"
                          />
                          <input
                            type="text"
                            inputMode="decimal"
                            ...
                            className="rounded-2xl border border-stone-200 px-4 py-3 text-sm outline-none focus:border-stone-500"
                          />
                          <input
                            type="text"
                            inputMode="decimal"
                          ...
                          <textarea
                            ...
                            placeholder={currentLang === "en" ? "Photo note" : "Fotoğraf notu"}
                            rows={3}
                            className="rounded-2xl border border-stone-200 px-4 py-3 text-sm outline-none focus:border-stone-500 md:col-span-2"
                          />
                        </div>
                        ...
                        >
                          {currentLang === "en" ? "Save note & location" : "Notu ve Konumu Kaydet"}
                        </button>
                      </form>
